...
val sparkMlLib =            "org.apache.spark" %% "spark-mllib"             % sparkVersion withSources()
val sparkHive =             "org.apache.spark" %% "spark-hive"              % "2.4.4" % "provided"
val sparkStreaming =        "org.apache.spark" %% "spark-streaming"         % sparkVersion withSources()
val sparkStreamingTwitter = "org.apache.bahir" %% "spark-streaming-twitter" % "2.4.0"
